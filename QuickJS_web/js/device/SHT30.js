...
class SHT30 {
  ...
  async get() {
    ...
    await this.wire.write(0x2C);
    await this.wire.write(0x06);
    ...
    await this.wire.requestFrom(this._address, 6);

    // Read 6 bytes of data
    // cTemp msb, cTemp lsb, cTemp crc, humidity msb, humidity lsb, humidity crc
    var data = await this.wire.read(6);

    await this.sleep(50);

    if (await this.wire.available() != 0)
      return 2;
